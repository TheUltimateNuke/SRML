...
namespace SRML.SR.SaveSystem.Format
{
    internal class ModWorldData : VersionedSerializable
    {
        ...
        readonly Dictionary<Identifiable.Id, float> econSaturations = new Dictionary<Identifiable.Id, float>();
        readonly List<string> lastOfferRancherIds = new List<string>();
        readonly List<string> pendingOfferRancherIds = new List<string>();
        static ModWorldData()
        {
