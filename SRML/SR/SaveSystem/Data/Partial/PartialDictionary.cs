...
namespace SRML.SR.SaveSystem.Data.Partial
{
    ...
    {
        readonly Predicate<KeyValuePair<K, V>> hoistPredicate;
        public readonly Dictionary<K, V> hoistedValues = new Dictionary<K, V>();

        private readonly Func<KeyValuePair<K, V>, KeyValuePair<K, V>?> hoistFiller;

        private readonly SerializerPair<K> keySerializer;
        private readonly SerializerPair<V> valueSerializer;
