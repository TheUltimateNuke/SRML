...
namespace SRML.SR.SaveSystem.Data.World
{
    ...
    {
        readonly PartialCollection<Identifiable.Id> spawnQueue = new PartialCollection<Identifiable.Id>(ModdedIDRegistry.IsModdedID, SerializerPair.GetEnumSerializerPair<Identifiable.Id>());
