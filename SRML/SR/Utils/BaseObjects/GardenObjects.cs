...
namespace SRML.SR.Utils.BaseObjects
{
    public static class GardenObjects
    {
        ...
        // Garden Positions
        public static readonly ObjectTransformValues[] spawnJoints = new ObjectTransformValues[]
        {
			// NORMAL SPAWN JOINTS
        ...
        public static readonly ObjectTransformValues[] beds = new ObjectTransformValues[]
        {
			// NORMAL BEDS
        ...
        public static readonly ObjectTransformValues[] bedSprouts = new ObjectTransformValues[]
        {
			// NORMAL SPROUTS
        ...
        public static readonly ObjectTransformValues[] droneNodes = new ObjectTransformValues[]
        {
			// NORMAL NODES
        ...
        public static readonly Dictionary<Identifiable.Id, Mesh> modelMeshs = new Dictionary<Identifiable.Id, Mesh>();
        public static readonly Dictionary<Identifiable.Id, Material[]> modelMaterials = new Dictionary<Identifiable.Id, Material[]>();

        public static readonly Dictionary<SpawnResource.Id, Mesh> modelSproutMeshs = new Dictionary<SpawnResource.Id, Mesh>();
        public static readonly Dictionary<SpawnResource.Id, Material[]> modelSproutMaterials = new Dictionary<SpawnResource.Id, Material[]>();

        public static readonly Dictionary<SpawnResource.Id, Mesh> modelTreeCols = new Dictionary<SpawnResource.Id, Mesh>();
        public static readonly Dictionary<SpawnResource.Id, Mesh> modelTreeMeshs = new Dictionary<SpawnResource.Id, Mesh>();
        public static readonly Dictionary<SpawnResource.Id, Material[]> modelTreeMaterials = new Dictionary<SpawnResource.Id, Material[]>();

        public static readonly Dictionary<SpawnResource.Id, Mesh> modelLeavesCols = new Dictionary<SpawnResource.Id, Mesh>();
        public static readonly Dictionary<SpawnResource.Id, Mesh> modelLeavesMeshs = new Dictionary<SpawnResource.Id, Mesh>();
        public static readonly Dictionary<SpawnResource.Id, Material[]> modelLeavesMaterials = new Dictionary<SpawnResource.Id, Material[]>();

        public static readonly Dictionary<SpawnResource.Id, List<ObjectTransformValues>> treeSpawnJoints = new Dictionary<SpawnResource.Id, List<ObjectTransformValues>>()
        {
