...
namespace SRML.SR.Utils.BaseObjects
{
    public static class BaseObjects
    {
        ...
        // Markers
        public static readonly Material fadeMat = new Material(Shader.Find("SR/Particles/Additive"));

        public static readonly Dictionary<MarkerType, Material> markerMaterials = new Dictionary<MarkerType, Material>()
        {
        ...
        public static readonly Dictionary<MarkerType, Material> markerAreaMaterials = new Dictionary<MarkerType, Material>()
        {
        ...
        public static readonly Dictionary<string, Mesh> originMesh = new Dictionary<string, Mesh>();
        public static readonly Dictionary<string, Material> originMaterial = new Dictionary<string, Material>();
        public static readonly Dictionary<string, PhysicMaterial> originPhysMaterial = new Dictionary<string, PhysicMaterial>();
        public static readonly Dictionary<string, Texture> originTexture = new Dictionary<string, Texture>();
        public static readonly Dictionary<string, Sprite> originSprite = new Dictionary<string, Sprite>();
        public static readonly Dictionary<string, AudioClip> originClips = new Dictionary<string, AudioClip>();
        public static readonly Dictionary<string, SECTR_AudioCue> originCues = new Dictionary<string, SECTR_AudioCue>();
        public static readonly Dictionary<string, SlimeSounds> originSounds = new Dictionary<string, SlimeSounds>();
        public static readonly Dictionary<string, GameObject> originFXs = new Dictionary<string, GameObject>();
        public static readonly Dictionary<string, RuntimeAnimatorController> originAnimators = new Dictionary<string, RuntimeAnimatorController>();
        public static readonly Dictionary<string, Avatar> originAvatars = new Dictionary<string, Avatar>();

        public static readonly Dictionary<string, GameObject> originSkinnedMesh = new Dictionary<string, GameObject>();
        public static readonly Dictionary<string, GameObject> originBones = new Dictionary<string, GameObject>();

        private static readonly List<string> materialBlacklist = new List<string>()
        {
            "Spawn Point Marker",
